...
public class SelezioneModificaNomeArtista extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaNomeArtista frame = new SelezioneModificaNomeArtista();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaNomeArtista() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textArea.getText()!=null) {
					i=stm.executeUpdate("alter table artista_progetto change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

				}
				else
					i=stm.executeUpdate("alter table artista_progetto change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText());
