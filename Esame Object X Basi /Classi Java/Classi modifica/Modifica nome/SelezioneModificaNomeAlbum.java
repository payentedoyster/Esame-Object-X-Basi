...
public class SelezioneModificaNomeAlbum extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaNomeAlbum frame = new SelezioneModificaNomeAlbum();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaNomeAlbum() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textArea.getText()!=null) {
					i=stm.executeUpdate("alter table album change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

				}
				else
					i=stm.executeUpdate("alter table album change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText());
