...
public class SelezioneModificaNomeTraccia extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaNomeTraccia frame = new SelezioneModificaNomeTraccia();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaNomeTraccia() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textArea.getText()!=null) {
					i=stm.executeUpdate("alter table traccia change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

				}
				else
					i=stm.executeUpdate("alter table traccia change "+ textNomeVecchio.getText() +" "+ textNomeNuovo.getText() +" "+ textTipo.getText());
