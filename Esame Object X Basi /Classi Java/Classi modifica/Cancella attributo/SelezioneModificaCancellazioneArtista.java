...
public class SelezioneModificaCancellazioneArtista extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaCancellazioneArtista frame = new SelezioneModificaCancellazioneArtista();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaCancellazioneArtista() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table artista_progetto drop "+ textDrop.getText());
