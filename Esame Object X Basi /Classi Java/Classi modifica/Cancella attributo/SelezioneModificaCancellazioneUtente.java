...
public class SelezioneModificaCancellazioneUtente extends JFrame {

	private JPanel contentPane;
	private JTextField textDrop;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaCancellazioneUtente frame = new SelezioneModificaCancellazioneUtente();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaCancellazioneUtente() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table utente drop "+ textDrop.getText());
