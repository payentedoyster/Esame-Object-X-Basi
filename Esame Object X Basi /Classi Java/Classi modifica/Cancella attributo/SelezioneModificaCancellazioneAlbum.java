...
public class SelezioneModificaCancellazioneAlbum extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaCancellazioneAlbum frame = new SelezioneModificaCancellazioneAlbum();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaCancellazioneAlbum() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table album drop "+ textDrop.getText());
