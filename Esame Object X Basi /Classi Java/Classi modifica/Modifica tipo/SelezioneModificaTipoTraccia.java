...
public class SelezioneModificaTipoTraccia extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaTipoTraccia frame = new SelezioneModificaTipoTraccia();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaTipoTraccia() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table traccia modify "+ textNome.getText() +" "+ textTipo.getText());
