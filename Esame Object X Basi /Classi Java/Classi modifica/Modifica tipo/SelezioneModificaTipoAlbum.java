...
public class SelezioneModificaTipoAlbum extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaTipoAlbum frame = new SelezioneModificaTipoAlbum();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaTipoAlbum() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table album modify"+ textNome.getText() +" "+ textTipo.getText());
