...
public class SelezioneModificaTipoUtente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaTipoUtente frame = new SelezioneModificaTipoUtente();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaTipoUtente() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i=stm.executeUpdate("alter table utente modify "+ textNome.getText() +" "+ textTipo.getText());
