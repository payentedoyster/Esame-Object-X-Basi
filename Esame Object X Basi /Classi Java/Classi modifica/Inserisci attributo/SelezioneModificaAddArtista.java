...
public class SelezioneModificaAddArtista extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaAddArtista frame = new SelezioneModificaAddArtista();
	 ...
	 * Create the frame.
	 */
	public SelezioneModificaAddArtista() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textArea.getText()!=null) {
					i=stm.executeUpdate("alter table artista_progetto add "+ textNome.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

				}
				else
					i=stm.executeUpdate("alter table artista_progetto add "+ textNome.getText() +" "+ textTipo.getText());
