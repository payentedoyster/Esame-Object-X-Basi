...
public class SelezioneModificaAddTraccia extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaAddTraccia frame = new SelezioneModificaAddTraccia();
	 ...
	 * Create the frame.
	 */
		public SelezioneModificaAddTraccia() {
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(textArea.getText()!=null) {
						i=stm.executeUpdate("alter table traccia add "+ textNome.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

					}
					else
						i=stm.executeUpdate("alter table traccia add "+ textNome.getText() +" "+ textTipo.getText());
