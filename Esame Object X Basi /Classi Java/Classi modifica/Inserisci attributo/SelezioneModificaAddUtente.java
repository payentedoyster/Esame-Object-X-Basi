...
public class SelezioneModificaAddUtente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelezioneModificaAddUtente frame = new SelezioneModificaAddUtente();
	 ...
	 * @return 
	 */
	public SelezioneModificaAddUtente() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textArea.getText()!=null) {
					i=stm.executeUpdate("alter table utente add "+ textNome.getText() +" "+ textTipo.getText() + " "+ textArea.getText());

				}
				else
					i=stm.executeUpdate("alter table utente add "+ textNome.getText() +" "+ textTipo.getText());
